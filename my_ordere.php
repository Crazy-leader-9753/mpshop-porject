...
<h1 class="mt-5 text-center">My orders</h1>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="mt-3 mb-2">Pending orders</h2>
                <?php
                    ...
                    <p class='fs-4 p-0 m-0'>".$data['p_name']."</p>
                     <p class='fs-6 p-0 m-0'>&#8377; ".$data['tp_amount']."</p>
                      <p class='fs-6 p-0 m-0'>Quantity:".$data['p_qty']."</p>
                       <p class='fs-6 p-0 m-0'>Order Date : <br>".$f_date."</p>
...
$user_email =base64_decode($_COOKIE['_aut_ui_']);
$get_data = $db->query("SELECT * FROM receive_order WHERE c_email = '$user_email'AND order_status ='completed'");
